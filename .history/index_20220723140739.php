...
<body class="container hold-transition layout-top-nav pl-0 pr-0">
                ...
                <div class=" container-fluid pr-1">
                    ...
                    <div class="collapse navbar-collapse order-3 border-b" id="navbarCollapse">
                        ...
                        <ul class="navbar-nav border-b">
                            <li class="nav-item">
                                <a type="submit" href="#" class="nav-link menu-nav nav-menu" id="dashboard">Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a type="submit" href="#" class="nav-link menu-nav nav-menu" id="produk">Produk</a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link menu-nav nav-menu">Estimasi Harga</a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link menu-nav nav-menu">Berita</a>
                            </li>
                            <?php
                        ...
                        <?php } ?>
                        <form method="post">
                            <input type="submit" id="menu" name="menu" value="">
                        </form>
                    </div>
                </div>
            </nav>
                ...
                if (isset($_POST['menu'])) {
                    ...
                    <script>
                        $(document).ready(function() {
                            $('#menu').val('okta');
                            // $('.halaman').load('pages/dashboard.php');
                        });
                    </script>
                <?php }
    ...
    <script>
        $('.nav-menu').click(function() {
            ...
            var file = $(this).parents().find("#menu").val(menu);
            file.trigger("click");
            alert($('#menu').val());
        });
