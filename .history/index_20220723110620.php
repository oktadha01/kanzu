                ...
                <div class=" container-fluid pr-1">
                    ...
                    <div class="collapse navbar-collapse order-3 border-b" id="navbarCollapse">
                        ...
                        <ul class="navbar-nav border-b">
                            <li class="nav-item">
                                <a type="submit" href="#" class="nav-link menu-nav" id="dashboard">Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a type="submit" href="#" class="nav-link menu-nav" id="produk">Produk</a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link menu-nav">Estimasi Harga</a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link menu-nav">Berita</a>
                            </li>
                            <?php
