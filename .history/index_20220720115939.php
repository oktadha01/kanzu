        ...
        <div class="wrapper">
            ...
            <nav id="navbar" class="main-header navbar navbar-expand-md navbar-light navbar-white" style="top: 0px; max-width: 1140px;">
                <div class=" container-fluid pr-1">
                    ...
                    <div id="" class="collapse navbar-collapse order-3 border-b" id="navbarCollapse">
                        <!-- Left navbar links -->
    ...
    <script>
        ...
        for (var i = 0; i < btns.length; i++) {
            btns[i].addEventListener("click", function() {
                // alert('ya');
                var current = document.getElementsByClassName("menu-nav-active");
                current[0].className = current[0].className.replace(" menu-nav-active", "");
                this.className += " menu-nav-active";
            });
        }
