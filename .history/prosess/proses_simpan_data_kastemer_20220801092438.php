...
if ($action_wa == 'wa-detail') {
    ...
    $daftar = mysqli_query($koneksi, "INSERT INTO kastemer (wa_nmperum, wa_tipeperum, nm_kastemer, no_wa, email) values ('$wa_nmperum', '$wa_tipeperum', '$nm_kastemer', '$no_wa', '$email')");
    if ($daftar) {
    ...
    $daftar = mysqli_query($koneksi, "INSERT INTO kastemer (wa_nmperum, wa_tipeperum, nm_kastemer, no_wa, email, wa_tipeperum, status_kstmr) values ('$wa_nmperum', '$wa_tipeperum', '$nm_kastemer', '$no_wa', '$email', '$wa_tipeperum', '$status_kstmr')");
    if ($daftar) {
