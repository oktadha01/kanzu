										...
										<thead>
											<tr>
												...
												?>
													...
													<td scope="col" class="text-center">
														<div class="">
															<img src="assets/img/ikon-display/carport2.png" alt="PT KANPA Logo" class="height-3rem img-circle elevation-3"><br>
															<center>
													...
													<?php } else { ?>
														<td scope="col" class="text-center">
															<div class="">
																<img src="assets/img/ikon-display/ruang-tamu.png" alt="PT KANPA Logo" class="height-3rem img-circle elevation-3"><br>
																<center>
													...
													<td scope="col" class="text-center">
														<div class="">
															<img src="assets/img/ikon-display/kamar-tidur.png" alt="PT KANPA Logo" class="height-3rem img-circle elevation-3"><br>
															<center>
													...
													<td scope="col" class="text-center">
														<div class="">
															<img src="assets/img/ikon-display/kamar-mandi.png" alt="PT KANPA Logo" class="height-3rem img-circle elevation-3"><br>
															<center>
													...
													<?php } else { ?>
														<td scope="col" class="text-center">
															<div class="">
																<img src="assets/img/ikon-display/r-makan.png" alt="PT KANPA Logo" class="height-3rem img-circle elevation-3"><br>
																<center>
