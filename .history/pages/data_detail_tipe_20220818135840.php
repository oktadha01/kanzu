                        ...
                        <div class="row">
                            <div class="col-12">
                                <div id="slideslantai" class="mySlideslantai">
                                    <img class="img-fluid max-height-27rem img-thumbnail" src="assets/img/foto_lantai1/<?php echo $row['fot_lantai1']; ?>">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mySlideslantai">
                                    <img class="img-fluid max-height-27rem img-thumbnail" src="assets/img/foto_lantai2/<?php echo $row['fot_lantai2']; ?>">
                                </div>
                            </div>
                        </div>
                    </center>
