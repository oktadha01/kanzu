                                    ...
                                    ?>
                                        <div class="column">
                                            <td class="text-center">
                                                <img class="demo cursor height-3rem img-thumbnail" src="assets/img/foto_slidetipe/<?php echo $data['file_slidetipe']; ?>" onclick="currentSlide(<?php echo $slide++; ?>)" alt="The Woods">
                                            </td>
                                        </div>
                                    <?php } ?>
                                </tr>
        ...
        <center>
            <div class="row">
                <div class="col-12 p-0">
                    <img class="img-fluid max-height-27rem" src="assets/img/foto_lantai1/<?php echo $row['fot_lantai1']; ?>" alt="PT KANPA Logo" />
                </div>
            </div>
        </center>
    <?php } else { ?>
        <div class="container">
            <center>
                <div class="row">
                    <div class="col-12">
                        <div id="slideslantai" class="mySlideslantai diplay-block">
                            <img class="img-fluid max-height-27rem" src="assets/img/foto_lantai1/<?php echo $row['fot_lantai1']; ?>">
                        </div>
                        <div class="mySlideslantai">
                            <img class="img-fluid max-height-27rem" src="assets/img/foto_lantai1/<?php echo $row['fot_lantai2']; ?>">
                        </div>
                    </div>
                </div>
            </center>
            <div class="row p-content-center">
                ...
                <div class="columnlantai p-1">
                    <div class="card">
                        <div class="card-body img-fluid p-1">
                            <img class="demolantai cursor img-fluid" src="assets/img/foto_lantai1/<?php echo $row['fot_lantai2']; ?>" onclick="currentSlidelantai(2)" alt="The Woods">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="p-content-center">
                <div class="columnlantai p-1">
                    <img class="demolantai cursor img-fluid img-thumbnail" src="assets/img/foto_lantai1/<?php echo $row['fot_lantai1']; ?>" onclick="currentSlidelantai(1)" alt="The Woods">
                </div>
                <div class="columnlantai p-1">
                    <img class="demolantai cursor img-fluid img-thumbnail" src="assets/img/foto_lantai2/<?php echo $row['fot_lantai2']; ?>" onclick="currentSlidelantai(2)" alt="The Woods">
                </div>
            </div>
            <center>
                ...
                <div class="mySlideslantai">
                    <img class="img-fluid max-height-27rem" src="assets/img/foto_lantai2/<?php echo $row['fot_lantai2']; ?>">
                </div>
            </center>
        </div>
    <?php } ?>
