							...
							<div class="p-2">
								...
								<div class="col-12 mb-2">
									<form method="post" action="index.php?p=detail" enctype="multipart/form-data">
										<center>
											<!-- <a type="submit" class="btn-sm bg-btn-detail btn-primary text-light">Lihat Detail >></a> -->
											<button id=""  class="btn btn-sm bg-gradient-success  elevation-3 float-right">Lihat Detail >></button>
											<input type="text" id="id_detail" name="id_detail" value="<?php echo $row['nm_perum']; ?>">
										</center>
									</form>
								</div>
							</div>
