    ...
    <?php } else { ?>
        <div class="container">
            ...
            <div class="row p-content-center">
                <div class="columnlantai p-1  p-content-center">
                    <img class="demolantai cursor img-fluid img-thumbnail max-height-6rem" src="assets/img/foto_lantai1/<?php echo $row['fot_lantai1']; ?>" onclick="currentSlidelantai(1)" alt="The Woods">
                </div>
                <div class="columnlantai p-1  p-content-center">
                    <img class="demolantai cursor img-fluid img-thumbnail max-height-6rem" src="assets/img/foto_lantai2/<?php echo $row['fot_lantai2']; ?>" onclick="currentSlidelantai(2)" alt="The Woods">
                </div>
            </div>
        </div>
    <?php } ?>
