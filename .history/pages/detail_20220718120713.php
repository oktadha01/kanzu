<?php
$no = 1;
$ambil_data = mysqli_query($koneksi, "SELECT *FROM perumahan, fasilitas WHERE perumahan.nm_perum='$_GET[id]'");
			...
			<div class="bg-detail row pl-2 pr-2">
				<div class="col-lg-4 col-md-4 col-12 pt-3">
					<center>
						...
						<p class="teks-desk text-align-justify calibri">
				...
				<div class="col-lg-4 col-md-4 col-12">
					...
					<h6 class="mb-1 mt-2 calibri"><?php echo $row['alamat']; ?></h6>
					<hr class="mt-1">
					<h5 class="font-weight-bold mt-2 mb-0"><i class="fa-solid fa-certificate"></i> SERTIFIKAT :</h5>
					<h6 class="mb-1 mt-2 calibri">HAK MILIK</h6>
					<hr class="mt-1">
					...
					<div class="row">
						...
						?>
							<div class="col-lg-6 col-12 mt-1">
								<i class="fa-solid fa-circle-check"> </i> <p class="calibri"> <?php echo $row['nmfas']; ?></p>
							</div>
						<?php
						}
						?>
					...
					<div class="row">
						...
						?>
							<div class="col-12 mt-1">
								<i class="fa-solid fa-location-dot"></i> <p class="calibri"> <?php echo $row['jarak']; ?> Menit Ke <?php echo $row['lokasi']; ?></p>
							</div>
						<?php } ?>
					</div>
					<hr>
