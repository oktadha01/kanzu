                    ...
                    <tr>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/TAMAN-01.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/balkon.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class="m-2">
                                    <img src="assets/img/carport2.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/ru-keluarga.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/ruang-tamu.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/kamar-tidur.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/kamar-mandi.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/r-makan.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
                        ...
                        <?php } else { ?>
                            <td scope="col" class="text-center">
                                <div class=" m-2">
                                    <img src="assets/img/dapur.png" alt="PT KANPA Logo" class="height-5rem img-circle"><br>
