											...
											<tr>
												...
												?>
													<td scope="col" class="text-center">
														<img src="assets/img/ikon-display/taman.png" alt="PT KANPA Logo" class="height-3rem"><br>
														<center>
															<h6><?php echo $spek['taman']; ?></h6>
														</center>
													</td>
													<td scope="col" class="text-center">
														<img src="assets/img/ikon-display/carport.png" alt="PT KANPA Logo" class="height-3rem"><br>
														<center>
															<h6><?php echo $spek['carportr']; ?></h6>
														</center>
													</td>
													<td scope="col" class="text-center">
														<img src="assets/img/ikon-display/ru-tamu.png" alt="PT KANPA Logo" class="height-3rem"><br>
														<center>
															<h6><?php echo $spek['ru_tamu']; ?></h6>
														</center>
													</td>
													<td scope="col" class="text-center">
														<img src="assets/img/ikon-display/ka-tidur.png" alt="PT KANPA Logo" class="height-3rem"><br>
														<center>
															<h6><?php echo $spek['ka_tidur']; ?></h6>
														</center>
													</td>
													<td scope="col" class="text-center">
														<img src="assets/img/ikon-display/ka-mandi.png" alt="PT KANPA Logo" class="height-3rem"><br>
														<center>
													...
													<?php } else { ?>
														<td scope="col" class="text-center">
															<img src="assets/img/ikon-display/dapur.png" alt="PT KANPA Logo" class="height-3rem"><br>
															<center>
													...
													<?php } else { ?>
														<td scope="col" class="text-center">
															<img src="assets/img/ikon-display/ru-keluarga.png" alt="PT KANPA Logo" class="height-3rem"><br>
															<center>
													...
													<?php } else { ?>
														<td scope="col" class="text-center">
															<img src="assets/img/ikon-display/ru-makan.png" alt="PT KANPA Logo" class="height-3rem"><br>
															<center>
													...
													<?php } else { ?>
														<td scope="col" class="text-center">
															<img src="assets/img/ikon-display/balkon.png" alt="PT KANPA Logo" class="height-3rem"><br>
															<center>
								...
								<div class="row">
									<div class="col-lg-4 col-md-4 col-12">
										...
										<div class="form-group ">
											...
											<input type="text" id="wa-nmperum" class="form-control" name="wa_nmperum" value="" hidden>
