						...
						<div class="bg-product">
							...
							<div class="p-2">
								...
								<div class="col-12 mb-2">
									<center>
										<form method="post" action="../index.php?p=detail">
											<input type="text" id="id_detail" value="">
										</form>
										<a type="submit" id="<?php echo $row['nm_perum']; ?>" class="btn-sm bg-btn-detail btn-primary btn-detail-perum">Lihat Detail >></a>
									</center>
								</div>
							</div>
						</div>
