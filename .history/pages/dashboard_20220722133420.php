						...
						<div class="bg-product">
							...
							<div class="p-2">
								...
								<div class="col-12 mb-2">
									<form method="post" action="proses/proses_edit_guru.php?id_user=<?php echo $row['id_user']; ?>" enctype="multipart/form-data">
										<center>
											<button id="" type="submit" class="btn btn-sm bg-gradient-success  elevation-3 float-right">
												<i class="fas fa-save mr-1"></i>Save</button>
											<!-- <a data-id="" class="btn-sm bg-btn-detail btn-primary">Lihat Detail >></a> -->
										</center>
