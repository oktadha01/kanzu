							...
							<div class="p-2">
								...
								<div class="col-12 mb-2">
									<form method="post" action="index.php?p=detail" enctype="multipart/form-data">
										<center>
											<!-- <a  class="btn-sm bg-btn-detail btn-primary text-light">Lihat Detail >></a> -->
											<button type="submit" class="btn-sm bg-btn-detail btn-primary text-light">Lihat Detail >></button>
