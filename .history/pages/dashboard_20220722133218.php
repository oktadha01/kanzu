						...
						<div class="bg-product">
							...
							<div class="p-2">
								...
								<div class="col-12 mb-2">
									<center>
										<button type="button" id="<?php echo $row['nm_perum']; ?>" data-id="" class="btn-sm bg-btn-detail btn-primary btn-detail-perum">test</button>
										<a href="#" data-id="<?php echo $row['nm_perum']; ?>" class="btn-sm bg-btn-detail btn-primary btn-detail-perum">Lihat Detail >></a>
									</center>
								</div>
							</div>
						</div>
