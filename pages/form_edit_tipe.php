	...
	<div class="row">
		<div class="col-lg-8 col-md-8 col-12">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-6">
					<label for="edit-ru-makan">RU-MAKAN</label>
					<div class="input-group mb-3">
						<div class="input-group-prepend">
							<span class="input-group-text pad-cus-6px">
		...
		<div class="col-lg-4 col-md-4 col-12">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					...
					<div class="form-group">
						<input type="text" id="edit-harga-m" class="form-control" name="harga_m" placeholder="Harga ..." autocomplete="off" required value="<?php echo $row['harga_m']; ?>">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					<div class="form-group">
						...
						<select id="edit-satuan-harga" name="satuan_harga" class="custom-select">
							<option value="">Pilih Satuan</option>
							<option selected disabled value="<?php echo $row['satuan_harga']; ?>"><?php echo $row['satuan_harga']; ?></option>
...
<script>
	...
	$(".simpan-edit-tipe").click(function() {
		...
		formData.append('edit-harga-m', $('#edit-harga-m').val());
		formData.append('edit-satuan-harga', $('#edit-satuan-harga').val());
